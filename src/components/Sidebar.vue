<template>
  ...
  >
    <div
      class="h-full px-3 py-4 overflow-y-auto bg-gradient-to-b from-white to-[#f4ccd2]"
    >
      <div class="flex justify-center">
        <img
          src="https://nocnoc.app/img/logos/Logo_outline.png"
          width="100"
          height="100"
          alt="logo"
        />
      ...
      <ul class="space-y-2 font-medium mt-10">
        <li v-if="user.role === 'super_admin'">
          ...
          >
            <svg
              class="w-5 h-5 text-[#f43f60] transition duration-75 group-hover:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 22 21"
        ...
        <li v-if="user.role === 'super_admin'">
          ...
          >
            <svg
              class="flex-shrink-0 w-5 h-5 text-[#f43f60] transition duration-75 group-hover:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 20 18"
